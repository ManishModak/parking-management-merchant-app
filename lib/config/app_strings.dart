class AppStrings {
  ...
  static const String menuModifyViewPlazaFare= 'Modify/View Plaza Fare Details';
  ...
  static const String errorRepeatPasswordEmpty = 'Repeat Password Cannot Be Empty';
  ...
  static const String errorMobileNumberInvalid = 'Please enter a valid 10-digit mobile number';
  static const String errorMobileVerificationFailed = 'Mobile number verification failed';
  ...
  static const String warningMobileVerificationRequired = 'Mobile number verification required';
  ...
  static const String errorPlazaOwnerNameRequired = 'Plaza Owner Name field is required';
  static const String errorPlazaOwnerNameLength = 'Plaza Owner Name length must be';
  ...
  static const String errorMobileLength = 'Mobile Number should contain exactly 10 digits';
  ...
  static const String errorEmailOrMobileRequired = 'Please enter email or mobile number';
  static const String errorValidEmailRequired = 'Please enter a valid email address';
  static const String errorValidMobileRequired = 'Please enter a valid mobile number';

  // Email validation messages
  static const String errorEmailRequired = 'Email ID field is required';
  static const String errorEmailLength = 'Email ID exceeds the allowed limit of 50 characters';
  static const String errorEmailInvalid = 'Invalid Email ID';
  static const String errorEmailMinLength = 'Email ID must be at least 10 characters';

  // Address validation messages
  static const String errorAddressRequired = 'Address field is required';
  static const String errorAddressLength = 'Address length must be between 1 to 256 characters';

  // City validation messages
  static const String errorCityRequired = 'City field is required';
  static const String errorCityLength = 'City length must be between 1 to 50 characters';

  // State validation messages
  static const String errorStateRequired = 'State field is required';
  static const String errorStateLength = 'State length must be between 1 to 50 characters';

  // Password validation messages
  static const String errorPasswordRequired = 'Password field is required';
  static const String errorPasswordLength = 'Password must be between 8 and 20 characters';
  static const String errorPasswordFormat = 'Password must contain at least one uppercase letter, one lowercase letter, one number, and one special character';

  // Confirm Password validation messages
  static const String errorConfirmPasswordRequired = 'Confirm Password field is required';
  static const String errorPasswordMismatch = 'Confirm Password must match Password';
  ...
  static const String errorFareTypeSelectionRequired = 'Please select a fare type';
  static const String errorVehicleTypeSelectionRequired = 'Please select a vehicle type';
  ...
  static const String errorBaseHourlyFareRequired = 'Please enter Base Hourly Fare';
  static const String errorMonthlyFareRequired = 'Please enter Monthly Fare';
  static const String errorAmountGreaterThanZero = 'Amount must be greater than 0';

  static const String errorStartDateRequired = 'Please enter Start Effective Date';
  ...
  static const String errorDiscountRequired = 'Please enter Discount Amount for Extended Hours';
  static const String errorInvalidDiscount = 'Discount must be greater than 0';

  static const String errorExistingSystemFare = 'Fare already exists for this plaza in system';
  static const String errorExistingTemporaryFare = 'Fare already exists for this plaza';
  static const String errorExistingVehicleClass = 'Vehicle class already exists for this plaza';
  static const String errorFareSubmission = 'Error adding fare: ';

  static const String successFareSubmission = 'All fares submitted successfully!';
  static const String warningNoFaresAdded = 'Please add at least one fare before submitting.';
