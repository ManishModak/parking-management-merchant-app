  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: const BoxDecoration(
        ...
        borderRadius: BorderRadius.vertical(top: Radius.circular(50)), // Rounded edges for container
      ),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceEvenly, // Evenly space icons without extra padding
        children: [
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: selectedIndex == index ? Colors.tealAccent : Colors.transparent,
          shape: BoxShape.circle,
        ),
        child: Icon(
          icon,
          color: selectedIndex == index ? Color(0xFF014245) : Colors.white70,
