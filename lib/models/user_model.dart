...
@override
String toString() {
return 'User(id: $id, name: $name, email: $email, mobile: $mobileNumber, address: $address, city: $city, state: $state, role: $role, entity: $entityName, subEntity: $subEntity, subEntityData: $subEntityData, entityId: $entityId)';
}
}
