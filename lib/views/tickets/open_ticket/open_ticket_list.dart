...
class _OpenTicketsScreenState extends State<OpenTicketsScreen> with RouteAware {
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text(strings.noOpenTicketsLabel,
              style: Theme.of(context)
                  .textTheme
                  .titleMedium
          ...
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 16.0),
            child: Text(
                _searchQuery.isEmpty && !_hasAnyActiveFilter()
  ...
  Widget _buildShimmerList() {
    return ListView.builder(
      ...
      physics:
          const NeverScrollableScrollPhysics(), // Prevents scrolling while loading
      itemCount: 10,
      padding: const EdgeInsets.only(top: 8.0, bottom: 8.0),
      itemBuilder: (context, index) {
        // Shimmer is applied to EACH individual item in the list
        return Shimmer.fromColors(
          ...
          child: Card(
            // IMPORTANT: Do NOT set a color on the card itself.
            margin: const EdgeInsets.symmetric(vertical: 8, horizontal: 16),
            elevation: 1, // A minimal elevation for the placeholder
                ...
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              color: Colors.white, // Neutral placeholder color
                        ...
                        const SizedBox(height: 6),
                        // Placeholder for the third (remarks) line
                        Container(
                          height: 12,
                          width: 150,
                          decoration: BoxDecoration(
                  ...
                  SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        // Placeholder for the status chip
                        Container(
                          width: 60,
                          height: 20,
                          decoration: BoxDecoration(
  ...
  Widget _buildTicketCard(Map<String, dynamic> ticket, S strings) {
    ...
    String formattedCreatedTime =
        _formatUtcToIstStringForDisplay(rawCreatedTimeUtc);
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<OpenTicketViewModel>(
      builder: (context, viewModel, _) {
        ...
        developer.log(
            'Filtered tickets: ${filteredTickets.length}, Paginated tickets: ${paginatedTickets.length}, CurrentPage: $_currentPage, TotalPages: $totalPages',
            name: 'OpenTicketsScreen');

        return Scaffold(
          backgroundColor: Theme.of(context).scaffoldBackgroundColor,
          appBar: CustomAppBar.appBarWithNavigation(
              screenTitle: strings.titleOpenTickets,
