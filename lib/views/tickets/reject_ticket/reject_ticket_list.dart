...
import 'view_reject_ticket.dart';
...
class _RejectTicketScreenState extends State<RejectTicketScreen>
  ...
  void initState() {
    super.initState();
    _viewModel = Provider.of<RejectTicketViewModel>(context, listen: false);
          ...
          child: Column(
            ...
            children: [
              CustomFormFields.searchFormField(
                ...
                hintText: strings.searchRejectTicketHint,
                context: context,
              ),
        ...
        return Theme(
          data: Theme.of(context).copyWith(
            colorScheme: ColorScheme.light(
              ...
              onPrimary: context.textPrimaryColor,
  ...
  Widget _buildErrorState(S strings) {
    ...
    if (error != null) {
      developer.log('Error occurred: $error', name: 'RejectTicketScreen');
  ...
  Widget _buildTicketCard(Map<String, dynamic> ticket, S strings) {
    DateTime entryTime = DateTime.parse(ticket['entryTime'] ?? DateTime.now().toIso8601String());
    ...
    return Card(
      ...
      child: InkWell(
        ...
        onTap: () {
          developer.log('Ticket card tapped: ${ticket['ticketId']}', name: 'RejectTicketScreen');
          Navigator.push(
            context,
            MaterialPageRoute(
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: Container(
                            ...
                            child: Text(
                              ticket['ticketStatus']?.toString() ?? strings.statusPending,
                              style: Theme.of(context).textTheme.bodySmall?.copyWith(
                                color: Colors.green,
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                strings.plazaNameLabel,
                                style: Theme.of(context).textTheme.bodySmall?.copyWith(
                                  color: textColor,
                                ),
                              ),
                              Text(
                                ticket['plazaName']?.toString() ?? strings.naLabel,
                                style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                                  fontWeight: FontWeight.w600,
                                  color: textColor,
                                ),
